  ...
  const GetTripData = useCallback(async () => {
    ...
    try {
      ...
      try {
        ...
        if (docSnap.exists()) {
          console.log('Trip loaded from Firebase:', docSnap.data());
      ...
      const localTrip = savedTrips.find(trip => trip.id === tripId);
      
      if (localTrip) {
        console.log('Trip loaded from localStorage:', localTrip);
        setTrip(localTrip);
      } else {
